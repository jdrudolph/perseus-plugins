...
namespace PerseusPluginLib.Test
{
    ...
    public class ProcessTextColumnsTest
    {
        ...
        private static void TestRegex(string regexStr, string[] stringsInit, string[] stringsExpect)
        {
            ...
            /*
            // TODO cannot reference PerseusFactory here since it is not part of perseusPlugins
            // this test needs to be moved to PerseusLib or changed to not use code from PerseusLib
