...
namespace PerseusApi.Matrix{
    ...
    public interface IMatrixData : IData{
        ...
        void SetData(string name, List<string> expressionColumnNames, float[,] expressionValues,
                     ...
                     List<string[][]> categoryColumns, List<string> numericColumnNames, List<double[]> numericColumns,
                     List<string> multiNumericColumnNames, List<double[][]> multiNumericColumns,
                     List<string> categoryRowNames, List<string[][]> categoryRows, List<string> numericRowNames,
        ...
        void SetData(string name, string description, List<string> expressionColumnNames,
                     List<string> expressionColumnDescriptions, float[,] expressionValues, bool[,] isImputed,
                     ...
                     List<string> categoryColumnNames, List<string> categoryColumnDescriptions,
                     List<string[][]> categoryColumns, List<string> numericColumnNames,
                     List<string> numericColumnDescriptions, List<double[]> numericColumns,
                     List<string> multiNumericColumnNames, List<string> multiNumericColumnDescriptions,
                     List<double[][]> multiNumericColumns, List<string> categoryRowNames,
                     List<string> categoryRowDescriptions, List<string[][]> categoryRows, List<string> numericRowNames,
                     List<string> numericRowDescriptions, List<double[]> numericRows);
